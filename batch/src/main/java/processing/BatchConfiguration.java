...
class BatchConfiguration {
	...
	// <1>
	@Bean
	Job etl(JobBuilderFactory jbf, StepBuilderFactory sbf, Step1Configuration step1, // <2>
			Step2Configuration step2, Step3Configuration step3) throws Exception {

		Step setup = sbf.get("clean-contact-table").tasklet(step1.tasklet(null)) // <3>
				.build();
		...
		// <9>
		Step s3 = sbf.get("db-file").<Map<Integer, Integer>, Map<Integer, Integer>>chunk(100)
